...
export type GetCartByIdQuery = { __typename?: 'Query', cart?: { __typename?: 'Cart', totalItems?: number | null, subTotal: { __typename?: 'Money', amount?: number | null, formatted: string }, items: Array<{ __typename?: 'CartItem', id: string, name?: string | null, quantity: number, unitTotal: { __typename?: 'Money', formatted: string } }> } | null };
